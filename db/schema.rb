...
ActiveRecord::Schema.define(version: 20_170_309_104_439) do
  ...
  add_index 'subscriptions', %w(project_id user_id), name: 'index_subscriptions_on_project_id_and_user_id', unique: true, using: :btree
